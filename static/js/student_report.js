...
async function captureData() {
    const url = 'http://127.0.0.1:5000/lapis/student-data/json'
...
async function selectClass() {
    ...
    for (let i = 0; i < data.length; i++) {
        if (data[i].School_name === selectedSchool) {
            let Schoolcode = data[i].school_code     /*getting school code */
            console.log(Schoolcode);                 /*printing scholl code in console */
            window.alert(Schoolcode);
